...
import { idlFactory } from './onchain360_backend.did.js';
export { idlFactory } from './onchain360_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ONCHAIN360_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./onchain360_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the onchain360_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./onchain360_backend.did.js")._SERVICE>}
 */
export const onchain360_backend = createActor(canisterId);
